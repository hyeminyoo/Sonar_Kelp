...
#  'courseOverGround' => {:offset=>118, :type=>'e', :len=>4},  # courseOverGround in radians
...
#  'sonar_data' => {:offset =>142, :type=>'C', :len=>3074}
}
...
open ARGV[0], 'r' do |f|
  ...
  while block_offset<sl2_file_size do
    ...
    unless output_h[[h['latitude'], h['longitude']]]
      ...
      csv_line = [h['longtitude'],h['latitude'],h['waterDepthM'].join(',')]
